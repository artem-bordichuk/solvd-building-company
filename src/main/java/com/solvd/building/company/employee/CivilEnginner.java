...
public class CivilEnginner extends Employee {
    private TypeOfProjects projectSpecializations;
    private int professionalRate;
    private int experience;
    private int salaryPerHour;

    public CivilEnginner() {
    }

    public CivilEnginner(String firstName, String secondName, String homeTown,
    ...
    public boolean equals(Object o) {
        ...
        CivilEnginner that = (CivilEnginner) o;
        return professionalRate == that.professionalRate
                && experience == that.experience
                && salaryPerHour == that.salaryPerHour
                && projectSpecializations == that.projectSpecializations;
    }

    @Override
    public int hashCode() {
        return Objects.hash(super.hashCode(), projectSpecializations, professionalRate, experience, salaryPerHour);
    }
}
